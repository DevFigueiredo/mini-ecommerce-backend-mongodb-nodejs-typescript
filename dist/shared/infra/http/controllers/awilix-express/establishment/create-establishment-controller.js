...
exports.CreateEstablishmentController = void 0;
...
let CreateEstablishmentController = class CreateEstablishmentController {
    constructor({ saveEstablishmentUseCase }) {
        this.saveEstablishmentUseCase = saveEstablishmentUseCase;
    }
    async execute(request, response) {
        const entity = request.body;
        await this.saveEstablishmentUseCase.execute({ entity });
        return response.status(http_status_helper_1.HttpStatusHelper.Created).end();
    }
};
__decorate([
...
], CreateEstablishmentController.prototype, "execute", null);
CreateEstablishmentController = __decorate([
    (0, awilix_express_1.route)('/establishment'),
    __metadata("design:paramtypes", [Object])
], CreateEstablishmentController);
exports.CreateEstablishmentController = CreateEstablishmentController;
