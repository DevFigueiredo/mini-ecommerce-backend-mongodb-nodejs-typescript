...
exports.FindByIdEstablishmentController = void 0;
const awilix_express_1 = require("awilix-express");
const http_status_helper_1 = require("../../../../../enums/http-status-helper");
let FindByIdEstablishmentController = class FindByIdEstablishmentController {
    constructor({ findByIdEstablishmentUseCase }) {
...
], FindByIdEstablishmentController.prototype, "execute", null);
FindByIdEstablishmentController = __decorate([
    (0, awilix_express_1.route)('/establishment'),
    __metadata("design:paramtypes", [Object])
], FindByIdEstablishmentController);
exports.FindByIdEstablishmentController = FindByIdEstablishmentController;
