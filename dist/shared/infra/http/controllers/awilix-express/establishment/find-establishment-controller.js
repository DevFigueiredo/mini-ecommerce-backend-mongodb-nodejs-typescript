...
exports.FindEstablishmentController = void 0;
const awilix_express_1 = require("awilix-express");
const http_status_helper_1 = require("../../../../../enums/http-status-helper");
let FindEstablishmentController = class FindEstablishmentController {
    constructor({ findEstablishmentsUseCase }) {
...
], FindEstablishmentController.prototype, "execute", null);
FindEstablishmentController = __decorate([
    (0, awilix_express_1.route)('/establishment'),
    __metadata("design:paramtypes", [Object])
], FindEstablishmentController);
exports.FindEstablishmentController = FindEstablishmentController;
