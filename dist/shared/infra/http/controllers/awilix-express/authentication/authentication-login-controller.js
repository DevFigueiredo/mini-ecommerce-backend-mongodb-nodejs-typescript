...
let CreateCustomerController = class CreateCustomerController {
    constructor({ authenticationSignEmailAndPasswordUseCase }) {
    ...
    async execute(request, response) {
        ...
        return response.status(http_status_helper_1.HttpStatusHelper.Created).json(authenticated);
    }
};
__decorate([
...
CreateCustomerController = __decorate([
    (0, awilix_express_1.route)('/authentication'),
